...
const HomeScreen = ({navigation}) => {
  const forms = [
    {id: 1, title: 'Gov Document', icon: 'assignment', screen: 'GovDocument'},
    {
      id: 2,
      title: 'Admission Form',
      icon: 'assignment-ind',
      screen: 'AdmissionForm',
    },
    {
      id: 3,
      title: 'Exam Form',
    ...
    },
    {
      ...
      icon: 'school',
      screen: 'DegreeCertificate',
    },
    {
      id: 5,
      title: 'Provisional or Migration',
      icon: 'swap-horiz',
      screen: 'ProvisionalMigration',
    },
    {id: 6, title: 'New Admission', icon: 'person-add', screen: 'NewAdmission'},
    {
      id: 7,
      title: 'Govt. Exam Form',
      icon: 'description',
      screen: 'GovtExamForm',
    },
    {
      id: 8,
      title: 'Your All Documents',
      icon: 'folder',
      screen: 'AllDocuments',
    },
    {
